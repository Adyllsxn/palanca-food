              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-4">
                  <div className="flex justify-between items-center mb-1">
                    ...
                    <a href="/auth/recover" className="text-sm text-indigo-600 hover:text-indigo-700">
                      Forgot password?
                    </a>
                  </div>
                ...
                <button
                  type="submit"
                  className="w-full py-2 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-lg transition mb-4 cursor-pointer"
                  disabled={isLoading}
                >
                ...
                <div className="flex gap-3 mb-4">
                  <button
                    type="button"
                    className="flex-1 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition flex items-center justify-center gap-2 cursor-pointer"
                  >
                ...
                <p className="text-center text-sm text-gray-600">
                  ...
                  <a href="/auth/signup" className="text-indigo-600 font-medium hover:text-indigo-700">
                    Create an account
                  </a>
                </p>
              </form>
