      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-6 gap-6 sm:gap-8 mb-8 sm:mb-12">
          ...
          <div className="text-left">
            <h3 className="text-white font-bold text-base sm:text-lg mb-3 sm:mb-4">Product</h3>
          ...
          {/* Community */}
          <div className="text-left">
            <h3 className="text-white font-bold text-base sm:text-lg mb-3 sm:mb-4">Community</h3>
            <ul className="space-y-1.5 sm:space-y-2">
          ...
          {/* Legal */}
          <div className="text-left">
            <h3 className="text-white font-bold text-base sm:text-lg mb-3 sm:mb-4">Legal</h3>
            <ul className="space-y-1.5 sm:space-y-2">
          ...
          {/* Resources */}
          <div className="text-left">
            <h3 className="text-white font-bold text-base sm:text-lg mb-3 sm:mb-4">Resources</h3>
            <ul className="space-y-1.5 sm:space-y-2">
