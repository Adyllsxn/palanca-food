        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-[#111111] rounded-2xl border border-gray-800 p-8 shadow-2xl">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-400 text-sm mt-1">Get started with Chatnal today</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex items-center">
                ...
                <label htmlFor="terms" className="ml-2 text-sm text-gray-400 cursor-pointer">
                  I agree to the{" "}
                  <a href="#" className="text-[#7C5CFF] hover:text-[#7C5CFF]/80">
                    Terms of Service
                  </a>{" "}
                  and{" "}
                  <a href="#" className="text-[#7C5CFF] hover:text-[#7C5CFF]/80">
              ...
              <button
                type="submit"
                className="group relative w-full inline-flex items-center justify-center gap-2 px-6 py-2.5 overflow-hidden transition-all duration-300 hover:scale-105 font-semibold rounded-lg cursor-pointer"
                style={{ 
              ...
              <p className="text-center text-sm text-gray-400">
                ...
                <Link href="/auth/signin" className="text-[#7C5CFF] font-medium hover:text-[#7C5CFF]/80 transition">
                  Sign in
                </Link>
              </p>
            </form>
