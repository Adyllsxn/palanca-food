            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <div className="flex justify-between items-center mb-1">
                  ...
                  <Link href="/auth/recover" className="text-sm text-[#7C5CFF] hover:text-[#7C5CFF]/80 transition">
                    Forgot password?
                  </Link>
                </div>
              ...
              <p className="text-center text-sm text-gray-400">
                ...
                <Link href="/auth/signup" className="text-[#7C5CFF] font-medium hover:text-[#7C5CFF]/80 transition">
                  Create an account
                </Link>
              </p>
            </form>
